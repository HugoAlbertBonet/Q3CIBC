...
from . import metrics as block_pushing_metrics
...
# gym >=0.26 changed `registration.registry` from an object with `.env_specs`
# to a plain dict. To stay compatible across versions, just guard against
# double-registration via direct dict membership.
_existing = registration.registry
if 'BlockPush-v0' in _existing:
  for _name in (
      'BlockInsert-v0', 'BlockPush-v0', 'BlockPushNormalized-v0',
      'BlockPushRgbNormalized-v0', 'BlockReach-v0', 'BlockReachNormalized-v0',
      'BlockReachRgbNormalized-v0', 'SharedBlockInsert-v0',
      'SharedBlockPush-v0', 'SharedBlockReach-v0',
  ):
    _existing.pop(_name, None)
