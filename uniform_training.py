"""Uniform/Langevin sampling training script for generator and estimator.
...
def main():
    ...
    wandb.init(
        ...
        name=f"{active_env}_uniform_cp{control_points}_lr{learning_rate}_sep{separation_weight}"
    )
    ...
    while step < training_steps:
        for batch in dataloader:
            ...
            # InfoNCE loss on raw values
            loss_infonce = lossInfoNCE(interpolated_estimations)
